            ...
            <table class="table table-bordered text-center">
                ...
                <td width="80" >
                      <?PHP
                        ...
                        {
                        echo"<a style='color:blue' class='cart btn btn-success' id='shope'><i  class='fa fa-shopping-cart'></i></a>";
                        }
                        else
                        {
                          echo"<a  class='cart btn btn-success' id='shope'><i  class='fa fa-shopping-cart'></i></a>";
                        }
                    ?>
                    </td>
