    ...
    <div class="row justify-content-center">
      <div class="col-lg-10">
       ...
       ?>
              <tr>
                <td><?= $i; ?></td>
               <td> <img  width="60" height="60"  src='<?= $imageURl; ?>'>
               <input type="hidden" class="product-id" value="<?= $id?>"></td>
                ...
                <td>
                  ...
                  <a href='#'  class="delete text-danger lead" > <i class="fas fa-trash-alt"></i></a>
            ...
            $total+=$sub_total; 
              ...
              <tr>
                ...
                <td>
                  <a href="main/checkout" class="btn btn-info "><i class="far fa-credit-card"></i>&nbsp;&nbsp;إتمام الشراء</a>
                </td>
              </tr>
            </tbody>
          </table>
